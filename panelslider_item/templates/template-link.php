...
if ($link && $element['slider_panel_link']) {
    ...
    $el->attr($link->attrs + [
        ...
        'class' => [
            ...
            'uk-display-block' => !($element['slider_panel_style'] && $element['has_panel_card_image'] && in_array($element['image_align'], ['left', 'right'])),
        ],
